...
class ButtonFunction(discord.ui.View):
    ...
    def __init__(self):
        ...
        self.add_item(
            discord.ui.Button(label='Click Here',
                              url="http://aochfl.tistory.com"))

    @discord.ui.button(label='primary',
    ...
    @discord.ui.button(label='secondary',
    ...
    @discord.ui.button(label='success',
                       style=discord.ButtonStyle.success,
                       row=2)
    async def button3(self, interaction: discord.Interaction,
                      button: discord.ui.Button):
    ...
    async def button4(self, interaction: discord.Interaction,
                      button: discord.ui.Button):
